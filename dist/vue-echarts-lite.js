...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3f777b3e_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_vue_echarts_lite_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "vue-echarts-lite.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] vue-echarts-lite.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3f777b3e", Component.options)
  } else {
    hotAPI.reload("data-v-3f777b3e", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mounted: function () {
        ...
        var chart = __WEBPACK_IMPORTED_MODULE_0_echarts___default.a.init(this.$el, this.theme);
        ...
        if (!this.$el.hasAttribute('unwatch')) {
            ...
            this.$watch('theme', function (newVal) {
                chart.dispose();
                chart = __WEBPACK_IMPORTED_MODULE_0_echarts___default.a.init(this.$el, newVal);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3f777b3e", esExports)
  }
}
